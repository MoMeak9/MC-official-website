        ...
        <v-row justify="center">
              ...
              <form>
                <v-row class="mt-15">
                  <v-col cols="12" md="6" class="py-0">
                    <v-text-field v-model="name" label="Name" outlined placeholder="Name"></v-text-field>
                  </v-col>
                  <v-col cols="12" md="6" class="py-0">
                    <v-text-field
                      v-model="email"
                ...
                <v-btn nuxt to="/" class="btn-custom-md btn-danger-gradient mt-12" outlined color="white" elevation="0">
                  Submit
                </v-btn>
              </form>
            </div>
          ...
          <v-col cols="12" sm="10" md="12" lg="4">
            <div class="primary contact-detail-card">
              <h2 class="detail-title font-weight-medium white--text">Wrappixel Headquarters</h2>
